...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                 ...
                 */
                .apis(RequestHandlerSelectors.basePackage("com.haylou.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                // 创建人信息
                .contact(new Contact("Luoxr", "https://blog.csdn.net/justry_deng", "13548417409@163.com"))
                // 版本号
                .version("1.0")
                // 描述
